          ...
          <div className="flex mb-4">
            ...
            <div className="ml-8">
              ...
              <ul className="list-disc ml-8 mb-4">
                <li>Phone: +91 9585958943</li>
                <li>Email: info@propartyapp.com</li>
                <li>Website: <a href="https://www.greenvalleygardens.com" className="text-blue-500">www.propartyapp.com</a></li>
