    ...
    return (
      <div className="container mx-auto p-4 mt-20">
        ...
        <div className="text-left">
          <h1 className="text-3xl font-bold text-gray-800 mb-4 font-poppins">BIRTHDAY CELEBRATION</h1>
        ...
        <div className="flex mb-8">
          <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1713806221/cake-1835443_1280_uwhyvq.jpg" alt="Cooking Workshop" className="h-80 object-contain rounded-lg" />
        </div>
        ...
        <a href='payment'><button  className="bg-green-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Book Now</button></a>
        </div>
