    ...
    return (
      <div className="container mx-auto p-4 mt-20">
        ...
        <div className="flex mb-8">
          <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1713806058/hand-1850120_1280_g8qz9m.jpg" alt="Cooking Workshop" className="h-80 object-contain rounded-lg" />
        </div>
