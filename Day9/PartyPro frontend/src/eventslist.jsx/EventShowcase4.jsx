    ...
    return (
      <div className="container mx-auto p-4 mt-20">
        ...
        <div className="text-left">
          <h1 className="text-3xl font-bold text-gray-800 mb-4 font-poppins">PUBERTY FUNCTION</h1>
        ...
        <div className="flex mb-8">
          <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1713500853/puberty-functions_l72d4x.webp" alt="Cooking Workshop" className="h-80 object-contain rounded-lg" />
        </div>
