      ...
      <div className="text-black text-left ml-0 mt-20 p-1 font-poppins">
        ...
        <Link to="/EventShowcase" className="bg-black hover:bg-black-100 text-white font-bold py-2 px-4 rounded mt-4">Book Now</Link>
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <div className="flex justify-">
        <Link to="/EventShowcase1" className="bg-black hover:bg-black-100 text-white font-bold py-2 px-4 rounded mt-4">Book Now</Link>
      </div>
          </div>
          {/* Event 3 */}
          <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <div className="flex justify-">
        <Link to="/EventShowcase2" className="bg-black hover:bg-black-100 text-white font-bold py-2 px-4 rounded mt-4">Book Now</Link>
      </div>
          </div>
          {/* Event 4 */}
          <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <div className="flex justify-">
        <Link to="/EventShowcase3" className="bg-black hover:bg-black-100 text-white font-bold py-2 px-4 rounded mt-4">Book Now</Link>
      </div>
          </div>
          {/* Event 5 */}
          <div className="bg-white rounded-lg shadow-md p-4">
           ...
           <div className="flex justify-">
        <Link to="/EventShowcase4" className="bg-black hover:bg-black-100 text-white font-bold py-2 px-4 rounded mt-4">Book Now</Link>
      </div>
          </div>
          {/* Event 6 */}
          <div className="bg-white rounded-lg shadow-md p-4">
           ...
           <div className="flex justify-">
        <Link to="/EventShowcase5" className="bg-black hover:bg-black-100 text-white font-bold py-2 px-4 rounded mt-4">Book Now</Link>
      </div>
          </div>
        </div>
      </div>
